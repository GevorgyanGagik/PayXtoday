  ...
  return (
    <section className="security__comp__container container">
      ...
      <div className="security__list">
        <div className="security__list__item">
      ...
      <ul>
        <li class="certifications__item">
          <div class="certifications__item-logo" data-aos="fade-right">
            <img src="https://payxtoday.com/images/pci.svg" alt="pci" />
          </div>
        ...
        <li class="certifications__item">
          <div class="certifications__item-logo two__img" data-aos="fade-right">
            <img
              style={{ width: "130px", height: "42px" }}
              src="https://payxtoday.com/images/visa.svg"
              alt="visa"
            />
            <img
              style={{ width: "115px", height: "89px" }}
              src="https://payxtoday.com/images/mastercard.svg"
              alt="master"
            />
          </div>
          <div class="certifications__item-content">
        ...
        <li class="certifications__item">
          <div class="certifications__item-logo" data-aos="fade-right">
            <img src="https://payxtoday.com/images/googlePay.svg" alt="psd2" />
          </div>
          <div class="certifications__item-content">
        ...
        <li class="certifications__item">
          <div class="certifications__item-logo" data-aos="fade-right">
            <img src="https://payxtoday.com/images/applePay.svg" alt="psd2" />
          </div>
          <div class="certifications__item-content">
        ...
        <li class="certifications__item">
          <div class="certifications__item-logo" data-aos="fade-right">
            <img src="https://payxtoday.com/images/psd.svg" alt="psd2" />
          </div>
          <div class="certifications__item-content">
